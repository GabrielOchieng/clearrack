...
//             Your store link configuration holds valid. Our team is reviewing
//             your parameters and will reach out over WhatsApp within 2 hours to
//             map out your dedicated live deployment.
//           </p>
//         </div>
...
//           <p className="text-[11px] text-red-500 font-bold text-center bg-red-50 py-2 rounded-lg border border-red-200">
//             Network anomaly detected. Please verify details and retry.
//           </p>
//         )}
